...
data_file = "citation_data/swiss_citation_extraction_filtered.json"
...
def train_model(model_name, custom_model_name, train_path, split_ratio, learning_rate, weight_decay, batch_size, epochs, compile_model):
    ...
    with open("citation_data/test.json", "wt") as file:
    ...
    trainer.train()
    model.save_pretrained(f"models_citation/{custom_model_name}")
...
epochs = 1
compile_model = False
custom_model_name = "CitationExtractorV0"
